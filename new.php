...
<html lang="en">
    ...
    <body>
        ...
        <div class="tagline">
            <div class="container">
                <div class="float-left">
                    <div class="phone">
                        <i class=" ti-mobile"></i> +1 510 435 3453
                    </div>
                    <div class="email">
                        <a href="mailto:#">
                            <i class=" ti-email"></i> brandondyer64@gmail.com
                        </a>
                    </div>
                </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand logo" href="#">Zero</a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="home-wrapper text-center">
                            <h1 class="animated fadeInDown wow" data-wow-delay=".1s">Zero Database</h1>
        ...
        <section class="section bg-gray" id="features">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <img src="images/mac.png" class="img-fluid">
                    </div>
        ...
        <section class="section" id="features1">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <img src="images/tab2.png" class="img-fluid screen-space">
                    </div>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-3 col-sm-3 facts">
                        ...
                        <h1><span class="counter">1.5</span> million</h1>
                        <h4>Lines of Code</h4>
                    </div>
                    <!-- /facts-1 -->
                    <div class="col-md-3 col-sm-3 facts">
                        <i class="ti-harddrives"></i>
                        <h1> <span class="counter">100</span>+ TB</h1>
                                        ...
                                        <div class="pricing-wrap">
                                            ...
                                            <div class="pricing-features">
                                                <ul class="sf-list pr-list">
                                                    <li>0% Off Custom Code</li>
                                                    <li>20 GB Base Storage</li>
                                                    <li>No Domain</li>
                                                    <li>1 User</li>
                                                    <li>Free Support</li>
                                                </ul>
